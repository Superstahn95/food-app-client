    ...
    >
      <div className="absolute top-0 left-0 w-full h-full bg-black/70 flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-5xl 2xl:text-7xl font-montserrat text-white capitalize font-bold">
          ...
          <p className="font-montserrat text-white text-center mx-auto text-lg leading-loose w-[40%]">
